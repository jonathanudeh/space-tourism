...
function MobileNav({ links, navOpen, onNavOpen }) {
  ...
  return (
    <div
      className={`fixed top-0 right-0 z-50 flex h-dvh w-50 flex-col gap-15 bg-transparent pt-5 pl-5 backdrop-blur-lg transition-all duration-500 md:hidden ${navOpen ? "translate-x-0 " : "translate-x-full"}`}
    >
      {/* close icon */}
      <button className="self-end p-4" onClick={handleNavClose}>
